...
const ProcessCard = ({ step, title, description, image, placeholder, color, cardRef, onEnter, onLeave }) => {
  return (
    <article
      ...
      className="js-process-card relative flex w-full max-w-[360px] flex-col rounded-[28px] px-7 py-4 shadow-[0_20px_50px_-30px_rgba(11,22,56,0.35)] will-change-transform"
    ...
    >
      ...
      <h3 className="font-display text-xl leading-tight font-bold text-ink">{title}</h3>
